...
MAX_LEN = 512
#probably I don't even have to do use IOB, but the ner_reader looks like it doesnt really import the gpt annotations
...
def ner_reader(tokenizer: AutoTokenizer, dataset: str, cache_name: str='', use_cache: bool=True):
    """
